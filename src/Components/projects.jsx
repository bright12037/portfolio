        ...
        <div>
            <div id='projects' className='md:mx-12 lg:mx-20 mx-5'>
                ...
                <div className='mt-10'>
                    ...
                    <div className='flex mt-6 transform gap-10 border-md bg-zinc-100 p-4 rounded-md h-[50vh] '>
                        <div className='flex-1'>
                        ...
                        <div className='flex-1 py-2'>
                            ...
                            <Link href="https://klas2-bright12037s-projects.vercel.app/dashboard" target="_blank" rel="noopener noreferrer"> <button className='px-8 text-white py-2 rounded-lg text-xl font-bold bg-slate-800 transition duration-300 ease-in-out transform hover:bg-blue-700 hover:scale-105'>VISIT</button></Link>
                        </div>
                    </div>
